                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="RegNo"><b>Receiver Reg No:</b></label>
                                            <div class="controls">
                                                <input type="text" id="RegNo" name="RegNo" placeholder="RegNo" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
$sql1="insert into library.message (RegNo,Msg,Date,Time) values ('$RegNo','$message',curdate(),curtime())";
