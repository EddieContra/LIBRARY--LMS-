                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                    $bookid = $_GET['id'];
                                    $sql = "select * from library.book where Bookid='$bookid'";
...
$sql1="update library.book set Title='$name', Publisher='$publisher', Year='$year', Availability='$avail' where BookId='$bookid'";
