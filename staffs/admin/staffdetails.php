            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <?php
                            $rno=$_GET['id'];
                            $sql="select * from library.user where RegNo='$rno'";
                            ...
                            $row=$result->fetch_assoc();    
                                ...
                                echo "<b><u>Reg No:</u></b> ".$rno."<br><br>";
                                echo "<b><u>Email Id:</u></b> ".$email."<br><br>";
                                echo "<b><u>Mobile No:</u></b> ".$phoneNo."<br><br>"; 
                            ?>               
                            
                        <a href="librarian.php" class="btn btn-primary">Go Back</a>                             
                               </div>
                           </div>
                        </div>
                    </div>
