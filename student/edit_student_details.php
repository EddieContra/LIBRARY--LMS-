                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                $sql="select * from library.user where RegNo='$RegNo'";
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $RegNo ?>" method="post">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="PhoneNo"><b>Mobile Number:</b></label>
                                        <div class="controls">
                                            <input type="text" id="PhoneNo" name="PhoneNo" value= "<?php echo $phoneNo?>" class="span8" required>
                                        </div>
                                    </div>
...
$sql1="update library.user set Name='$name',EmailId='$email', PhoneNo='$phoneNo', Password='$pswd' where RegNo='$RegNo'";
