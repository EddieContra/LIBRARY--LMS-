        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                    	<center>
                        <p style="font-size: 30px;"><b>WELCOME TO IAA LIBRARY MANAGEMENT SYSTEM</b></p>
                           	<div class="card" style="width: 55%;">
                    			<img class="card-img-top" src="images/iaa.png" alt="iaa logo">
                    			<div class="card-body">
                                ...
                                ?>    
                    				...
                    				<br>
                    				<p><b>Registration number: </B><?php echo $RegNo ?></p><br>
                    				<p><b>Mobile number: </b><?php echo $phoneNo ?></p>
                    				</b>
